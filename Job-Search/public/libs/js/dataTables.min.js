 ...
 *   https://datatables.net/download/#dt/jq-3.3.1/dt-1.10.22/af-2.3.5/b-1.6.5/cr-1.5.2/fc-3.3.1/fh-3.1.7/kt-2.5.3/r-2.2.6/rg-1.1.2/rr-1.2.7/sc-2.0.3/sb-1.0.0/sp-1.2.1/sl-1.3.1
 *
 * Included libraries:
 *  jQuery 3.3.1, DataTables 1.10.22, AutoFill 2.3.5, Buttons 1.6.5, ColReorder 1.5.2, FixedColumns 3.3.1, FixedHeader 3.1.7, KeyTable 2.5.3, Responsive 2.2.6, RowGroup 1.1.2, RowReorder 1.2.7, Scroller 2.0.3, SearchBuilder 1.0.0, SearchPanes 1.2.1, Select 1.3.1
 */
...
(function(k) {
    ...
    u.ext = L = {
        ...
        classes: {},
        builder:
            "dt/jq-3.3.1/dt-1.10.22/af-2.3.5/b-1.6.5/cr-1.5.2/fc-3.3.1/fh-3.1.7/kt-2.5.3/r-2.2.6/rg-1.1.2/rr-1.2.7/sc-2.0.3/sb-1.0.0/sp-1.2.1/sl-1.3.1",
        errMode: "alert",
        feature: [],
        search: [],
            ...
            if ("focus" === g)
                ...
                b(d.table().body()).on("click" + c, "td, th", function(c) {
                    ...
                    b(e.body).on("click" + c, function(c) {
                        b(c.target)
                            .parents()
                            .filter(d.table().body()).length || a._detach();
                    });
            else
                b(d.table().body())
...
(function(e) {
                ...
                if (m)
                    if (Array.isArray(m)) this._expandButton(a, m, c, d);
                        ...
                        l &&
                            ...
                            m.init &&
                                m.init.call(h.button(l.node), h, e(l.node), m),
                            f++);
                    }
            }
        },
                ...
                h = function(g, m) {
                    ...
                    if (Array.isArray(g) || g instanceof e)
                        ...
                        if (-1 !== g.indexOf(","))
                            ...
                            for (
                                g = g.replace(":name", ""), p = 0, l = n.length;
                                p < l;
                                p++
                            )
                                n[p].name === g &&
    ...
    e.extend(x, {
        ...
        excel: function(a, b) {
            if (x.excelHtml5 && x.excelHtml5.available(a, b))
                return "excelHtml5";
            if (x.excelFlash && x.excelFlash.available(a, b))
                return "excelFlash";
        },
        pdf: function(a, b) {
    ...
    t.Api.register("buttons()", function(a, b) {
        ...
        var c = this.iterator(
            ...
            function(d) {
                if (d._buttons)
                    return w.buttonSelector(
                        w.instanceSelector(a, d._buttons),
                        b
                    );
            },
            !0
    ...
    t.Api.registerPlural("buttons().active()", "button().active()", function(
        a
    ) {
        return a === u
            ? this.map(function(b) {
    ...
    t.Api.registerPlural("buttons().action()", "button().action()", function(
        a
    ) {
        return a === u
            ? this.map(function(b) {
    ...
    d.extend(k.prototype, {
        ...
        _fnMouseDown: function(a, b) {
            ...
            b !== w &&
                ...
                this._fnRegions(),
                d(r)
                    .on("mousemove.ColReorder touchmove.ColReorder", function(
                        a
                    ) {
...
(function(c) {
    ...
    c.extend(l.prototype, {
        ...
        _modeChange: function(a, b, k) {
            ...
            "in-place" === a
                ? (e.placeholder &&
                      (e.placeholder.remove(), (e.placeholder = null)),
                  this._unsize(b),
...
(function(b) {
    ...
    b.extend(t.prototype, {
        ...
        _constructor: function() {
            ...
            if (this.c.blurable)
                b(k).on("mousedown" + d, function(f) {
                    b(f.target).parents(".dataTables_filter").length &&
                        a._blur();
                    b(f.target)
                        .parents()
            ...
            if (this.c.editor) {
                ...
                if (this.c.editOnFocus)
                    c.on("key-focus" + d + " key-refocus" + d, function(
                        f,
                        q,
                        r,
                        v
                    ...
                    var q = function() {
                        p.one("open" + f, function() {
                            ...
                            p.one("close" + f, function() {
                                ...
                                p.off(f);
                                b(h.table().container()).removeClass(
                                    "dtk-focus-alt"
                                );
                            });
                        })
                ...
                if (
                    ...
                    if (d)
                        if (this.s.dt.cell(d.node).any()) {
                            d = this.s.dt;
                            var h = this.s.dt.settings()[0].oScroll.sY
                                ? !0
                                : !1;
                            if (
                                !this.c.keys ||
        ...
        _scroll: function(a, c, e, d) {
            ...
            a = a.width();
            "position" === d &&
                (h.top += parseInt(e.closest("table").css("top"), 10));
...
(function(a) {
    ...
    a.extend(g.prototype, {
        ...
        _group: function(b, d) {
            for (
                var h = a.isArray(this.c.dataSrc)
                        ? this.c.dataSrc
                        : [this.c.dataSrc],
        ...
        _groupDisplay: function(b, a) {
            for (var d = this.s.dt, c, h = 0, e = a.length; h < e; h++) {
                var f = a[h],
                    ...
                    k = f.rows;
                this.c.startRender &&
                    ((c = this.c.startRender.call(this, d.rows(k), g, b)),
                    (c = this._rowWrap(c, this.c.startClassName, b)) &&
                        c.insertBefore(d.row(k[0]).node()));
                this.c.endRender &&
                    ((c = this.c.endRender.call(this, d.rows(k), g, b)),
                    (c = this._rowWrap(c, this.c.endClassName, b)) &&
                        c.insertAfter(d.row(k[k.length - 1]).node()));
    ...
    a(d).on("preInit.dt.dtrg", function(b, d, c) {
        "dt" === b.namespace &&
            ((b = d.oInit.rowGroup), (c = e.defaults.rowGroup), b || c) &&
            ((c = a.extend({}, c, b)), !1 !== b && new g(d, c));
    });
    return g;
});
...
(function(a) {
    ...
    var g = a.fn.dataTable,
        h = function(b, e) {
            ...
            this.dom.dtScroll.length ||
                (this.dom.dtScroll = a(this.s.dt.table().container(), "tbody"));
            b.rowreorder = this;
            this._constructor();
        };
    a.extend(h.prototype, {
        ...
        _clonePosition: function(a) {
            ...
            0 > c
                ? (c = 0)
                : c + this.s.domCloneOuterHeight > this.s.documentOuterHeight &&
                  (c = this.s.documentOuterHeight - this.s.domCloneOuterHeight);
        ...
        _mouseMove: function(b) {
            this._clonePosition(b);
            for (
                var e = this._eventToPage(b, "Y") - this.s.bodyTop,
                    c = this.s.middles,
                    d = null,
                    f = this.s.dt,
                    g = 0,
                ...
                ? ((this.c.enable = !1),
                  this.c.editor
                      .edit(
                          p,
                          !1,
                          a.extend({ submit: "changed" }, this.c.formOptions)
                      )
                      .multiSet(g, k)
        ...
        _shiftScroll: function(b) {
            ...
            h < a(f).scrollTop() + 65
                ? (k = -5)
                : h > c.windowHeight + a(f).scrollTop() - 65 && (k = 5);
            ...
            !this.s.scrollInterval &&
                ...
                (this.s.scrollInterval = setInterval(function() {
                    if (c.windowVert) {
                        ...
                        b !== a(d).scrollTop() &&
                            ((b = parseFloat(e.dom.clone.css("top"))),
                            e.dom.clone.css("top", b + c.windowVert));
                    }
                    c.dtVert &&
                        ((b = e.dom.dtScroll[0]),
    ...
    a(d).on("init.dt.dtr", function(b, d, c) {
        "dt" === b.namespace &&
            ((b = d.oInit.rowReorder), (c = g.defaults.rowReorder), b || c) &&
            ((c = a.extend({}, b, c)), !1 !== b && new h(d, c));
    });
    return h;
});
...
$jscomp.polyfill = function(d, f, g, h) {
    f &&
        ($jscomp.ISOLATE_POLYFILLS
            ? $jscomp.polyfillIsolated(d, f, g, h)
            : $jscomp.polyfillUnisolated(d, f, g, h));
};
...
(function(d) {
        ...
        m = function(a, b) {
            this instanceof m
                ? (b === h && (b = {}),
                  ...
                  (this.s = d.extend(this.s, m.oDefaults, b)),
    ...
    d.extend(m.prototype, {
        ...
        scrollToRow: function(a, b) {
            ...
            b === h || b
                ? ((this.s.ani = e),
                  d(this.dom.scroller).animate({ scrollTop: l }, function() {
                      setTimeout(function() {
                          c.s.ani = !1;
                      }, 250);
                  }))
                ...
                p =
                    ...
                    a.fnRecordsDisplay() == a.fnRecordsTotal()
                        ...
                        : b.sInfo
                          ...
                          b.sInfoPostFix;
                (b = b.fnInfoCallback) &&
                    (p = b.call(a.oInstance, a, e, c, l, n, p));
                e = a.aanFeatures.i;
        ...
        _parseHeight: function(a) {
            ...
            "px" === c
                ...
                : "em" === c &&
                  (b = a * parseFloat(d("body").css("font-size")));
            return b ? b : 0;
        },
        _scroll: function() {
            var a = this,
    ...
    q.register("scroller().rowToPixels()", function(a, b, c) {
        var e = this.context;
        if (e.length && e[0].oScroller)
            return e[0].oScroller.rowToPixels(a, b, c);
    });
    q.register("scroller().pixelsToRow()", function(a, b, c) {
        var e = this.context;
        if (e.length && e[0].oScroller)
            return e[0].oScroller.pixelsToRow(a, b, c);
    });
    q.register(["scroller().scrollToRow()", "scroller.toPosition()"], function(
        a,
        b
    ) {
        this.iterator("table", function(c) {
        ...
        return k
            ...
            : function(p, r, f) {
                  ...
                  if ("function" == typeof y) {
                      ...
                      for (y = p.length, C = 0; C < y; C++)
                          x.push(r.call(f, p[C], C));
                  return x;
              };
    },
    "es6",
        ...
        return k
            ...
            : function(p, r) {
                  return (
                      -1 !==
                      $jscomp
                          .checkStringArgs(this, p, "includes")
                          .indexOf(p, r || 0)
                  );
              };
    },
        ...
        c.extend(l.prototype, {
            ...
            owns: function(d) {
                return (
                    ...
                    c(d)
                        .parents()
                        .filter(this.dom.container).length
                );
            },
            val: function(d, h) {
            ...
            _writeOutput: function(d) {
                var h = this.s.d,
                    m = g
                        ? g
                              .utc(h, e, this.c.locale, this.c.strict)
    ...
    var f,
        ...
        C = (function() {
            function c(a, b, e, g, l) {
                ...
                this.dom = {
                    ...
                    valueTitle: f(
                        '<option value="" disabled selected hidden/>'
                    ).text(this.s.dt.i18n("searchBuilder.value", "Value"))
                };
                if (this.c.greyscale)
                    for (
                        f(this.dom.data).addClass(this.classes.greyscale),
                            f(this.dom.condition).addClass(
            ...
            c.prototype.setListeners = function() {
                ...
                f(this.dom.data)
                    ...
                    .on("input", function() {
                        ...
                        a.s.dataIdx = f(a.dom.data)
                            .children("option:selected")
                            .val();
                        a.s.data = f(a.dom.data)
                            .children("option:selected")
                            .text();
                        a._clearCondition();
                        a._clearValue();
                ...
                if (0 !== f(document).has(this.dom.container).length) {
                    ...
                    if (0 !== f(this.dom.container).has(a).length) {
                        ...
                        var e = f(this.dom.left).offset(),
                            ...
                            d =
                                0 !==
                                f(this.dom.container).has(this.dom.left).length,
                            h =
                                0 !==
                                f(this.dom.container).has(this.dom.right)
                                    .length,
            ...
            c.prototype._populateCondition = function() {
                ...
                if (0 === this.s.conditions.size) {
                    var b = f(this.dom.data)
                        .children("option:selected")
                        .val();
                    this.s.type = this.s.dt
                        .columns()
                        .type()
                        .toArray()[b];
                    null === this.s.type &&
                    ...
                    -1 !== this.s.type.indexOf("moment") &&
                        (this.s.momentFormat = this.s.type.replace(
                            /moment\-/g,
                            ""
                        ));
                ...
                if (0 === this.s.dataPoints.length)
                    this.s.dt.columns().every(function(d) {
                        if (
                            ...
                            h ||
                                ((d = {
                                    text: a.s.dt.settings()[0].aoColumns[d]
                                        .sTitle,
                                    index: d
                                }),
                    ...
                    for (
                        var b = function(d) {
                                e.s.dt.columns().every(function(m) {
                                    a.s.dt.settings()[0].aoColumns[m].sTitle ===
                                        d.text && (d.index = m);
                                });
                                var h = f("<option>", {
                                    text: d.text,
            ...
            c.prototype._populateValue = function(a) {
                ...
                for (var g = 0, l = this.dom.value; g < l.length; g++)
                    f(l[g]).remove();
                ...
                for (var b = !0, e = 0; e < a.length; e++) {
                    ...
                    f(g).children("option:selected").length ===
                        f(g).children("option").length -
                            f(g).children("option." + c.classes.notItalic)
                                .length &&
            ...
            c.updateListener = function(a, b) {
                ...
                for (var g = (e = null), l = 0; l < a.dom.value.length; l++)
                    b === a.dom.value[l][0] &&
                        ((e = l),
                        void 0 !== b.selectionStart && (g = b.selectionStart));
                a.s.dt.draw();
                null !== e &&
        ...
        t = (function() {
                ...
                for (var a = 0; a < this.s.criteria.length; a++)
                    void 0 === this.s.criteria[a].logic
                        ? ((this.s.criteria[a].index = a),
                          ...
                          q(
                              this.s.criteria[a].criteria.dom.container
                          ).insertBefore(this.dom.add),
                          this._setCriteriaListeners(
            ...
            c.prototype.setupLogic = function() {
                ...
                if (1 > this.s.criteria.length)
                    ...
                    q(this.dom.clear).outerHeight(
                        q(this.dom.logicContainer).height()
                    );
            ...
            c.prototype.setListeners = function() {
                ...
                q(this.dom.add).on("click", function() {
                    a.s.isChild ||
                        q(a.dom.container).prepend(a.dom.logicContainer);
                    a.addCriteria();
            ...
            c.prototype._setup = function() {
                ...
                this.c.greyscale &&
                    q(this.dom.logic).addClass(this.classes.greyscale);
                q(this.dom.logicContainer)
                    .append(this.dom.logic)
                    .append(this.dom.clear);
                this.s.isChild &&
                    q(this.dom.container).append(this.dom.logicContainer);
        ...
        K = (function() {
                    ...
                    var e = function(h) {
                            void 0 !== h.criteria
                                ...
                                : g.s.dt.columns().every(function(m) {
                                      b.s.dt.settings()[0].aoColumns[m]
                                          .sTitle === h.data && (h.dataIdx = m);
                                  });
                        },
                        g = this,
                        l = 0,
                ...
                a &&
                    ...
                    null !== a && void 0 !== a.searchBuilder
                        ? (this.s.topGroup.rebuild(a.searchBuilder),
                          n(this.s.topGroup.dom.container).trigger(
                              "dtsb-redrawContents"
                          ),
            ...
            c.prototype._setRedrawListener = function() {
                ...
                n(this.s.topGroup.dom.container).on(
                    "dtsb-redrawContents",
                    function() {
                        a._checkClear();
...
(function(c) {
    "function" === typeof define && define.amd
        ...
        ? (module.exports = function(a, b) {
              ...
              (b && b.fn.dataTable) ||
                  (b = require("datatables.net-dt")(a, b).$);
              b.fn.dataTable.searchBuilder ||
                  require("datatables.net-searchbuilder")(a, b);
              return c(b, a, a.document);
          })
        : c(jQuery, window, document);
})(function(c, a, b) {
    ...
    var g,
        ...
        u = (function() {
                ...
                this.s.searchFunction = function(n, w, z, x) {
                    ...
                    f.colExists &&
                        ...
                        "filter" !== l.orthogonal.filter &&
                            ...
                            n instanceof g.fn.dataTable.Api &&
                                (n = n.toArray())));
            ...
            h.prototype.destroy = function() {
                ...
                for (
                    var a = g.fn.dataTable.ext.search.indexOf(
                    ...
                    g.fn.dataTable.ext.search.splice(a, 1),
                        (a = g.fn.dataTable.ext.search.indexOf(
                            this.s.searchFunction
                        ));
                    ...
                    if (!this.s.dt.page.info().serverSide && null === c) {
                        if (0 === n.arrayFilter.length)
                            if (
                                ...
                                if (-1 !== A)
                                    (n.binsOriginal =
                                        x.searchPanes.panes[A].bins),
                                        (n.arrayOriginal =
                                            x.searchPanes.panes[A].arrayFilter);
                                else {
                                    this.dom.container.addClass(
                                        this.classes.hidden
                                    );
                ...
                this.s.dtPane = g(this.dom.dtP).DataTable(
                    g.extend(
                        !0,
                        {
                            columnDefs: [
                                {
                                    ...
                                    type:
                                        void 0 !==
                                        f.settings()[0].aoColumns[this.s.index]
                                            ? f.settings()[0].aoColumns[
                                                  this.s.index
                                              ]._sManualType
                                            : null
                                },
                            ...
                            scroller: e ? !0 : !1,
                            select: !0,
                            stateSave: f.settings()[0].oFeatures.bStateSave
                                ? !0
                                : !1
                        },
                        this.c.dtOpts,
                        ...
                        for (
                            ...
                            (l = e[v]),
                                void 0 !== this.s.dtPane.row(l).data() &&
                                    n.filter ===
                                        this.s.dtPane.row(l).data().filter &&
                                    (this.s.dt.page.info().serverSide
                                        ? ((this.s.serverSelecting = !0),
                ...
                if (void 0 !== a) {
                    ...
                    if (void 0 !== b) {
                        ...
                        for (
                            ...
                            -1 < k &&
                                (c.row(k).select(), this.s.dt.state.save());
                        }
                    }
                }
            };
                            ...
                            : this.c.cascadePanes &&
                              this.s.dt
                                  ...
                                  this.s.dt
                                      ...
                                      .data()
                                      .toArray().length
                            ? ((d.arrayFilter = d.arrayOriginal),
                              (d.bins = d.binsOriginal))
                            : (this.c.viewTotal || this.c.cascadePanes) &&
                              this._populatePane();
                        this.c.viewTotal
                            ? this._detailsPane()
        ...
        G = (function() {
            ...
            h.prototype.redrawPanes = function(a) {
                ...
                if (!this.s.updating && !this.s.dt.page.info().serverSide) {
                    ...
                    if (
                        ...
                        for (var e = 0, k = this.s.panes; e < k.length; e++) {
                            ...
                            if (void 0 !== f.s.dtPane) {
                                ...
                                if (0 === l)
                                    for (
                                        var p = 0, n = this.s.selectionList;
                                        p < n.length;
                                        p++
                                    ) {
                                        var w = n[p];
                    ...
                    if (this.regenerating) {
                        ...
                        if (
                            0 < e.length &&
                            (e.length < this.s.selectionList.length || a)
                        )
                            for (
            ...
            h.prototype._serverTotals = function() {
                ...
                for (d = this.s.panes; b < d.length; b++)
                    (k = d[b]),
                        ...
                        void 0 !== k.s.dtPane &&
                            ((q(
                                k.s.dtPane.table().node()
                            ).parent()[0].scrollTop = k.s.scrollTop),
            ...
            h.prototype._startup = function(a) {
                ...
                if (
                    ...
                    for (
                        var d = !1, e = 0, k = c.searchPanes.panes;
                        e < k.length;
                        e++
                    ) {
                        var f = k[e];
                ...
                a.on("destroy.dtsps", function() {
                    for (var l = 0, p = b.s.panes; l < p.length; l++)
                        p[l].destroy();
                    a.off(".dtsps");
