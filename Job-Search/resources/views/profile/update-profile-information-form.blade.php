<x-jet-form-section submit="updateProfileInformation">
    ...
    <x-slot name="form">
        ...
        <div class="col-span-6 sm:col-span-4">
            ...
            <x-jet-input id="phone-number" type="text" class="mt-1 block w-full"
                wire:model.defer="state.phone_number" />
            <x-jet-input-error for="phone-number" class="mt-2" />
        </div>
        ...
        <div class="col-span-6 sm:col-span-4">
            ...
            <select class="form-control text-capitalize" id="gender" name="gender_id"
                wire:model.defer="state.gender_id">
                @foreach (\App\Models\Gender::all() as $gender)
                <option value='{{$gender->id}}' class='text-capitalize'>
                    {{ $gender->name }}
                </option>
                @endforeach
            </select>
            <script text="text/javascript">
                $('#gender').val({{$this->user->gender->id}});
            </script>
        </div>
    </x-slot>
